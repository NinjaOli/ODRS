...
class Ball {
    generateDescription() {
        ...
        description.innerHTML = "Today's challenge is... THE ELEGANZA EXTRAVAGANZA BALL! The queens will bring three looks to the runway! The themes are: " + desc1[randomNumber(0, 6)] + desc2[randomNumber(0, 6)] + desc3[randomNumber(0, 6)];
    }
    rankPerformances() {
        for (let i = 0; i < currentCast.length; i++)
